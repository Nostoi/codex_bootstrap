...
describe('TaskCard Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('renders task description when provided', () => {
      ...
      expect(screen.getByText('This is a test task description for testing purposes.')).toBeInTheDocument();
    });
  ...
  describe('AI Suggestions and Dependencies', () => {
    it('displays AI suggestion callout', () => {
      ...
      expect(screen.getByText('This task could benefit from breaking into smaller subtasks.')).toBeInTheDocument();
    });
  ...
  describe('Compact Mode', () => {
    it('applies compact styling and hides description', () => {
      ...
      expect(screen.queryByText('This is a test task description for testing purposes.')).not.toBeInTheDocument();
    ...
    it('hides AI suggestion in compact mode', () => {
      ...
      expect(screen.queryByText('This task could benefit from breaking into smaller subtasks.')).not.toBeInTheDocument();
    });
  });
