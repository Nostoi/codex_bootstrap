...
const baseTask: EnhancedTask = {
  ...
  description:
    'Create login, signup, and password reset functionality with proper validation and error handling.',
  status: 'IN_PROGRESS',
  energyLevel: 'HIGH',
  focusType: 'TECHNICAL',
  priority: 4,
...
export const HighPriorityWithDeadline: Story = {
  args: {
    task: {
      ...
      isOverdue: false,
      aiSuggestion:
        'This security issue affects user authentication. Prioritize this over other tasks.',
    },
  },
};
...
export const CreativeTaskWithAISuggestion: Story = {
  args: {
    task: {
      ...
      source: 'AI_GENERATED',
      aiSuggestion:
        'Consider using progressive disclosure and clear visual hierarchy to reduce cognitive load for ADHD users.',
    },
  },
};
...
export const SocialTaskFromBoss: Story = {
  args: {
    task: {
      ...
      description:
        'Prepare and deliver a comprehensive presentation on Q4 achievements and Q1 planning.',
      status: 'TODO',
      energyLevel: 'HIGH',
      focusType: 'SOCIAL',
      priority: 4,
...
export const KeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use Tab to focus, Enter or Space to activate. All interactive elements should be keyboard accessible.',
      },
    },
  },
};
...
export const ScreenReaderFriendly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story includes comprehensive ARIA labels and metadata for screen reader testing. Use a screen reader to verify all information is properly announced.',
      },
    },
  },
};
