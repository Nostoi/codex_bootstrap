...
const meta: Meta<typeof FocusView> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "The FocusView component displays today's tasks with AI-powered prioritization and focus goal setting. Central to the Helmsman daily productivity workflow.",
      },
    },
    a11y: {
      config: {
...
export const Default: Story = {
  args: {
    ...
    aiRecommendation:
      'Based on your current priorities, I suggest focusing on the high-priority design tasks first. The onboarding flow is blocking other team members, so completing that would unblock 3 other developers.',
  },
};
...
export const HighWorkload: Story = {
  args: {
    ...
    aiRecommendation:
      'You have 8 hours of work scheduled but only 6 hours available. I recommend moving 2 medium-priority tasks to tomorrow and focusing on the authentication work first.',
  },
};
...
export const MostlyCompleted: Story = {
  args: {
    ...
    aiRecommendation:
      "Great progress! You're 80% complete with today's goals. The final review should take about 30 minutes, putting you ahead of schedule.",
  },
};
...
export const NoFocusGoal: Story = {
  args: {
    ...
    focusGoal: '',
    aiRecommendation:
      'Setting a daily focus goal can increase productivity by 25%. Try identifying your most important outcome for today.',
  },
};
...
export const Accessible: Story = {
  args: {
    ...
    aiRecommendation:
      'Focus on keyboard navigation and screen reader compatibility first - these impact the most users.',
  },
  parameters: {
    a11y: {
      config: {
