    ...
    return (
      <button
        ...
        style={{
          ...
          color: day.isCurrentMonth ? 'var(--color-text-primary)' : 'var(--color-text-secondary)',
      ...
      >
        ...
        {hasEvents && (
          <div id={`events-${day.date.toISOString().split('T')[0]}`} className="sr-only">
            {day.events.length === 1
    ...
    return (
      ...
      >
        ...
        <div className="accessible-calendar__header" style={{ marginBottom: 'var(--space-4)' }}>
          <div
            className="accessible-calendar__navigation"
            style={{
              display: 'flex',
        ...
        {/* Live announcements */}
        <LiveRegion level="polite">{announcement}</LiveRegion>
        ...
        >
          Use arrow keys to navigate dates. Press PageUp/PageDown to change months. Press Home/End
          to go to first/last day of month. Press Enter or Space to select a date.
        </div>
      </div>
    );
  }
