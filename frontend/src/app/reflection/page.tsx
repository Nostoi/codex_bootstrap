  ...
  const [reflections] = useState<ReflectionEntry[]>([
    {
      ...
      content: 'Today I made significant progress on the frontend components. The Docker setup is working perfectly and all tests are passing. I feel confident about the direction we&apos;re taking.',
      mood: 5,
    ...
    },
    {
      ...
      content: 'Spent most of the day fixing ESLint issues. It was frustrating but ultimately rewarding to have clean, compliant code.',
      mood: 3,
    ...
    },
    {
      ...
      content: 'This week was focused on improving code quality and setting up proper development workflows. The investment in tooling is paying off.',
      mood: 4,
      ...
      <div className="navbar bg-primary text-primary-content">
        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal px-1">
            ...
            <li><Link href="/reflection" className="text-accent">Reflection</Link></li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="form-control">
                  ...
                  <select 
                    ...
                    onChange={(e) => setNewEntry({...newEntry, category: e.target.value as 'daily' | 'weekly' | 'monthly'})}
                  >
                ...
                <div className="form-control">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      value={newEntry.mood}
                      onChange={(e) => setNewEntry({...newEntry, mood: parseInt(e.target.value) as 1 | 2 | 3 | 4 | 5})}
                    />
