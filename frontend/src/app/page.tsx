  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-background-secondary">
        <div className="max-w-4xl mx-auto text-center space-comfortable">
          <h2 className="text-3xl font-bold text-text-primary">ADHD-Friendly Design System</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
            ...
            <div className="space-comfortable">
              ...
              <ul className="text-sm text-text-secondary space-y-2">
                <li>
                  • <span className="energy-high">High energy</span> tasks
                </li>
                <li>
                  • <span className="energy-medium">Medium energy</span> tasks
                </li>
                <li>
                  • <span className="energy-low">Low energy</span> tasks
                </li>
