...
test.describe('Navigation Tests', () => {
  test('homepage navigation works', async ({ page }) => {
    ...
    await expect(
      page.getByRole('navigation').getByRole('link', { name: 'Reflection' })
    ).toBeVisible();
    await expect(
...
test.describe('Navigation Between Pages', () => {
  ...
  test('quick nav cards navigate correctly', async ({ page }) => {
    ...
    await page
      .getByRole('link', { name: 'Reflection Journal thoughts with cognitive load reduction' })
      .click();
    await expect(page).toHaveURL('/reflection');
    ...
    // Test settings card
    await page
      .getByRole('link', { name: 'Settings Customize accessibility and preferences' })
      .click();
    await expect(page).toHaveURL('/settings');
  });
});
