...
describe('FeatureFlagsService', () => {
  ...
  describe('isEnabled', () => {
    ...
    it('should return default value when no overrides exist', async () => {
      const result = await service.isEnabled(FeatureFlags.ENHANCED_TASK_METADATA);
    ...
    it('should handle percentage rollouts', async () => {
      ...
      const result = await service.isEnabled(FeatureFlags.DAILY_PLANNING, 'test-user', userHash);
