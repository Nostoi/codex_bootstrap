...
export class FeatureFlagsController {
  ...
  @ApiResponse({ status: 200, description: 'Feature flag configurations retrieved successfully' })
  getAllConfigs() {
    return {
  ...
  @ApiResponse({ status: 200, description: 'Feature flag status retrieved successfully' })
  async isEnabled(
