...
export class TasksController {
  ...
  @ApiQuery({ name: 'ownerId', required: false, description: 'Filter tasks by owner ID' })
  ...
  @ApiResponse({ status: 404, description: 'Task not found' })
  async getTaskDependencies(@Param('id') id: string): Promise<TaskDependency[]> {
  ...
  @ApiResponse({ status: 400, description: 'Invalid input or circular dependency' })
  @ApiResponse({ status: 404, description: 'Task not found' })
  ...
  @ApiResponse({ status: 400, description: 'Dependency does not belong to task' })
...
export class UserSettingsController {
  ...
  @ApiResponse({ status: 400, description: 'Invalid input or settings already exist' })
