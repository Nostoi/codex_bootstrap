...
export const testSelectors = {
  dashboard: {
    ...
    tasksGrid: '.grid.grid-cols-1.md\\:grid-cols-2.gap-4', // Task cards grid
    taskGrid: '.grid.grid-cols-1.md\\:grid-cols-2.gap-4', // Alias for tasksGrid for test compatibility
  ...
  aiIntegration: {
    ...
    textInput: 'textarea[placeholder*="Ask AI"]',
