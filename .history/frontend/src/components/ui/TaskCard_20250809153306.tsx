      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1 min-w-0">
          ...
          {task.description && !compact && (
            <p data-testid="task-description" className="text-sm text-gray-600 mt-1 line-clamp-2">
              {task.description}
            </p>
          )}
        </div>
        <span
          ...
          className={`ml-3 px-2 py-1 rounded-full text-xs font-medium ${statusStyle.badge}`}
        >
          {statusStyle.label}
        </span>
      </div>
