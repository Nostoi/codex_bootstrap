...
let FeatureFlagsController = class FeatureFlagsController {
    ...
    async getAllFlags(userId) {
        const userHash = userId ? feature_flags_service_1.FeatureFlagsService.createUserHash(userId) : undefined;
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Feature flag configurations retrieved successfully' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Feature flag status retrieved successfully' }),
